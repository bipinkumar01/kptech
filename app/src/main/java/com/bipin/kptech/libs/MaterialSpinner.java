...
public class MaterialSpinner extends AppCompatSpinner implements ValueAnimator.AnimatorUpdateListener {
    ...
    */
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setBackgroundResource(R.drawable.material_spinner_background);
    }
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        int defaultErrorColor = context.getResources().getColor(R.color.material_error_color);
        ...
        disabledColor = context.getResources().getColor(R.color.material_disabled_color);
    ...
    private void initPaintObjects() {
        int labelTextSize = getResources().getDimensionPixelSize(R.dimen.material_spinner_label_text_size);
    ...
    private void initDimensions() {
        underlineTopSpacing = getResources().getDimensionPixelSize(R.dimen.material_spinner_underline_top_spacing);
        underlineBottomSpacing = getResources().getDimensionPixelSize(R.dimen.material_spinner_underline_bottom_spacing);
        floatingLabelTopSpacing = getResources().getDimensionPixelSize(R.dimen.material_spinner_floating_label_top_spacing);
        floatingLabelBottomSpacing = getResources().getDimensionPixelSize(R.dimen.material_spinner_floating_label_bottom_spacing);
        rightLeftSpinnerPadding = alignLabels ? getResources().getDimensionPixelSize(R.dimen.material_spinner_right_left_spinner_padding) : 0;
        floatingLabelInsideSpacing = getResources().getDimensionPixelSize(R.dimen.material_spinner_floating_label_inside_spacing);
        errorLabelSpacing = (int) getResources().getDimension(R.dimen.material_spinner_error_label_spacing);
        minContentHeight = (int) getResources().getDimension(R.dimen.material_spinner_min_content_height);
    }
